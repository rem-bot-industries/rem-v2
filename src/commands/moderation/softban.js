    ...
    async run(msg) {
        ...
        if (reason === '') {
            reason = this.t('ban.default-reason', {
                ...
                mod: utils.getMemberNameDiscrim(msg.member)
            });
        } else {
        ...
        try {
            ...
            try {
                await target.unban(this.t('softban.auto-unban', {
                    lngs: msg.lang,
                    user: utils.getMemberNameDiscrim(target)
                }));
                return msg.channel.createMessage(this.t('softban.success', {
                    lngs: msg.lang,
                    user: utils.getMemberNameDiscrim(target)
                }));
            } catch (e) {
                return msg.channel.createMessage(this.t('softban.error-unban', {
                    lngs: msg.lang,
                    user: utils.getMemberNameDiscrim(target)
                }));
            }
            ...
            return msg.channel.createMessage(this.t('ban.error', {lngs: msg.lang}));
        }
    }
}
